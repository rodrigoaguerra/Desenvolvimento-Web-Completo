(function ($) {
    ...
    wp.storelycustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                storely_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.storelycustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.storelycustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.storelycustomizerRepeater.iconPickerToggle($(this));
        });
